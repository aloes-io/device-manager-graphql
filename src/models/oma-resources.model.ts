...
/**
 * The model class is generated from OpenAPI schema - OMAResources
 * OMA resources schema
 */
@model({name: 'OMAResources'})
export class OmaResources {
  constructor(data?: Partial<OmaResources>) {
...
export interface OmaResourcesRelations {
  // describe navigational properties here
}

export type OmaResourcesWithRelations = OmaResources & OmaResourcesRelations;
